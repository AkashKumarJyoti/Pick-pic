...
class _ImageUploadState extends State<ImageUpload> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        children: [
          Container(height: 30.0, color: const Color(0xFF388E3C),),
          Container(
            height: 100,
                        ...
                        ClipOval(
                          child: Container(
                              ...
                              child: Icon(Icons.person,
                                  color: Colors.green.shade300, size: 150)),
                        ),
                      Positioned(
                        bottom: 0,
                        right: 0,
                        child: InkWell(
                          onTap: () {
                            if (image == null) {
                              showToast("Select Image", Icons.image, context);
                            } else {
                              showToast(
                                  "Uploading Image...", Icons.upload, context);
                              uploadImage();
                            }
                          },
                          child: Container(
